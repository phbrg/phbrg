...
2. [SabaraAPI](https://github.com/phbrg/sabaraAPI): an API that replicates an ERP system made for a college project, developed in Python, FastAPI, and PostgreSQL
